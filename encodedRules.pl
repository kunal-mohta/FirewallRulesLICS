...
% rule('reject udp dst port 123-321 src port 222').
% rule('reject udp dst port 101,103 src port 1-10').
% rule('accept udp dst port any').

% ----------------- ICMP Clause Rules ----------------- %
% rule('drop icmp code 0123,0124').
...
% ----------------- IPv4 Clause Rules ----------------- %
rule('drop ip addr 192.167.10.0x9-192.167.10.0xF').
